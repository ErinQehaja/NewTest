...
namespace Programmiertest2
{
    public class School
    {
        ...
        {
            return Students.Count(s => s.PersonGender.Equals(gender, StringComparison.OrdinalIgnoreCase));
        }
        ...
        public double GetFemalePercentageInClass(string className)
        {
            ...
            var femaleCount = studentsInClass.Count(s => s.PersonGender.Equals("Female", StringComparison.OrdinalIgnoreCase));
